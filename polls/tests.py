...
def create_question(question_text, days):
    ...
    Create a question with the 'given question_text' and published the given number of 'days' offset
     to now - negative for questions published in the past - positive for questions not published yet.
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """"Questions with past pub_date - dispayed on index page"""
    ...
    def test_future_question_and_past_question(self):
        """" If both questions exist - display only past questions"""
        question = create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
        response = self.client.get(reverse("polls:index"))
        self.assertQuerySetEqual(
